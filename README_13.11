...
1 шаг) Упорядочиваем задачи по времени окончания.
2 шаг) Добавляем в пустой список задачи в правильном порядке.
3 шаг) Для каждой задачи проверяется условие: время начала ≥ времени окончания последней выбранной задачи
